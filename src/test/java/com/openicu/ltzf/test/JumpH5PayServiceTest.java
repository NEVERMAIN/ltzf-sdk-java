...
import com.openicu.ltzf.payments.jumph5.model.PrepayRequest;
import com.openicu.ltzf.payments.jumph5.model.PrepayResponse;
...
public class JumpH5PayServiceTest {
    ...
    public void init() {
        ...
        this.jumpH5PayService = factory.jumpH5PayService();
    }
    ...
    public void test_prepay() throws IOException {
        ...
        PrepayResponse response = jumpH5PayService.prepay(prepayRequest);
